...
- Active documentation: `CLAUDE.md`, `openspec/config.yaml`, `openspec/changes/storage-boxes-review-fixes/{design.md,proposal.md,specs/storage-boxes/spec.md,specs/test-infrastructure/spec.md,tasks.md}`, `openspec/specs/storage-boxes.md`, `skills/hetzner/references/authentication.md`.
